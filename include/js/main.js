...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : 'include/img/slider-images/image01.jpg', title : '<div class="slide-content">Javid Hsueh</div>', thumb : '', url : ''},
											{image : 'include/img/slider-images/image02.jpg', title : '<div class="slide-content">Visualization</div>', thumb : '', url : ''},
											{image : 'include/img/slider-images/image03.jpg', title : '<div class="slide-content">Storyline</div>', thumb : '', url : ''},
											{image : 'include/img/slider-images/image04.jpg', title : '<div class="slide-content">Photo</div>', thumb : '', url : ''}
									],
